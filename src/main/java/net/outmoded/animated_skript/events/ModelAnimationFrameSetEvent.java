...
public final class ModelAnimationFrameSetEvent extends Event implements Cancellable {
    ...
    public ModelAnimationFrameSetEvent(UUID uuid, String type, String animationName, String loopMode, int oldFrameTime, int futureFrameTime, int maxFrameTime) {
        this.uuid = uuid;
        modelType = type;
