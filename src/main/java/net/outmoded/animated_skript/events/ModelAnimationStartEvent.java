...
public final class ModelAnimationStartEvent extends Event implements Cancellable {
    ...
    public ModelAnimationStartEvent(UUID uuid, String type, String animationName) {
        this.uuid = uuid;
        modelType = type;
